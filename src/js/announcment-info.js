...
const bigdescription = document.querySelector(".big__screen_grid .info__description"),
    bigdescHeader = bigdescription.querySelector(".desc__header");
...
const big_scren_buttons = document.querySelector("#btn__big_screen"),
    small_screen_buttons = document.querySelector("#btn__small_screen"),
    desc__big_screen = document.querySelector("#desc__big_screen"),
    desc__small_screen = document.querySelector("#desc__small_screen")
